...
#
# Table structure for table 'tx_bstextclassification_domain_model_categoryfingerprint'
#
CREATE TABLE tx_bstextclassification_domain_model_categoryfingerprint (
