...
mydata <- read.csv("C:/xampp/htdocs/Master_Project/file_10specificcats.csv")
...
par(mar=c(4, 5,5, 2))
layout(rbind(1,2), heights=c(7,1))
plot(x, y, xlab="x", ylab="y",cex.lab=1.2, type="n")
text(x, y, labels = firstCol, cex=1.2, col = c("darkgreen","blue","darkviolet","darkred","darkorange","yellow","lightblue","green","red","darkgrey")[firstCol]) 
...
legend("left",bty = "n", c("Fashion","Technology"), col = c("green","darkblue"),cex=1.2,lty=1,lwd=5, y.intersp = 0.4,x.intersp=0.4) 
